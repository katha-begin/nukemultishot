...
def SubmitJob(dialog, root, node, writeNodes, deadlineTemp, tempJobName, tempFrameList, tempDependencies, tempChunkSize, tempIsMovie, jobCount, semaphore,  extraInfo):
    ...
    fileHandle.write("Pool={}\n".format(dialog.pool.value()))
    # ---------------------------------------------------
    # STUDIO ENVIRONMENT VARIABLES (FARM SAFE NUKE)
    # ---------------------------------------------------

    ocio_path = "/mnt/ppr_dev_t/pipeline/ocio/aces_2.0/studio-config-v1.0.0_aces-v1.3_ocio-v2.0.ocio"

    fileHandle.write("EnvironmentKeyValue0=OCIO={}\n".format(ocio_path))
    fileHandle.write("EnvironmentKeyValue1=NUKE_DISABLE_GPU_ACCELERATION=1\n")
    fileHandle.write("EnvironmentKeyValue2=DISPLAY=\n")  # prevents 'Bad value for display'
    fileHandle.write("EnvironmentKeyValue3=QT_QPA_PLATFORM=offscreen\n")
    fileHandle.write("EnvironmentKeyValue4=LIBGL_ALWAYS_SOFTWARE=1\n")
