...
This module provides a simple gizmo-based multishot_switch that routes inputs
...
- Uses TCL expression to route to matching input (1-5)
...
# Keep this for backward compatibility - creates the gizmo
